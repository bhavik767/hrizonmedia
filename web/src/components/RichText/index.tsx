...
import type {
  ...
  GlobalCarouselBlock as GlobalCarouselBlockProps,
...
const jsxConverters: JSXConvertersFunction<NodeTypes> = ({ defaultConverters }) => ({
  ...
  blocks: {
    ...
    formBlock: ({ node }) =>
      typeof node.fields.form === 'object' ? (
        <FormBlock
          {...node.fields}
          enableIntro={Boolean(node.fields.enableIntro)}
          form={node.fields.form}
        />
      ) : null,
    carousel: ({ node }) => <CarouselBlock {...node.fields} />,
    globalCarousel: ({ node }) => <GlobalCarouselBlock {...node.fields} />,
    youtubeVideo: ({ node }) => <YouTubeVideoBlock {...node.fields} />,
  },
})
